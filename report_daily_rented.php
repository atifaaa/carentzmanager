...
<div class="form-group CVV">
			 ...
			 <div class="col-md-12">
					...
					if ($st=="2")
					{
					  $sql_a = "SELECT rental.*, customer.*, vehicle.* FROM rental INNER JOIN customer ON rental.id=customer.id INNER JOIN vehicle ON rental.id_car=vehicle.id_car where rental.status_trans='Used' and date(rental.start_date)='$tgl'";
					}
					if ($st=="3")
					{
