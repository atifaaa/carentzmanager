...
<div class="form-group CVV">
			 ...
			 <div class="col-md-12">
					...
					if ($st=="1")
					{
					  $sql_a = "SELECT rental.*, customer.*, vehicle.* FROM rental INNER JOIN customer ON rental.id=customer.id INNER JOIN vehicle ON rental.id_car=vehicle.id_car where rental.status_trans='Booked' and rental.date_tran='$tgl'";
					}
					if ($st=="2")
					{
					  $sql_a = "SELECT rental.*, customer.*, vehicle.* FROM rental INNER JOIN customer ON rental.id=customer.id INNER JOIN vehicle ON rental.id_car=vehicle.id_car where rental.status_trans='Used' and rental.date_tran='$tgl'";
					}
					if ($st=="3")
					{
					  $sql_a = "SELECT rental.*, customer.*, vehicle.* FROM rental INNER JOIN customer ON rental.id=customer.id INNER JOIN vehicle ON rental.id_car=vehicle.id_car where rental.status_trans='Finished' and rental.date_tran='$tgl'";
					}
