	  ...
	  ?>
            ...
            <div class="border-head">
			 ...
			 <div class="form-group CVV">
							...
							<a href="customer_add.php" class="btn btn-warning" >Add Customer</a>
                    ...
                    while($rowa = mysqli_fetch_array($myQrya))
					{
						...
						<td>
						<img src='img/<?php	echo $rowa['cust_picture'];?>' height='50' width='50' >
            <img src='img/<?php	echo $rowa['cust_driving'];?>' height='50' width='50' >
            <img src='img/<?php	echo $rowa['cust_idcard'];?>' height='50' width='50' >
						</td>
						<td>
						<a href="customer_edit.php?id=<?php echo $rowa['id'];?>" class="btn btn-info btn-sm update" ><i class="fa fa-edit">Edit</i></a>
						<a href="customer_delete.php?id=<?php echo $rowa['id'];?>" class="btn btn-danger" onclick="return confirm('Delete customer ... ?')"><i class="fa fa-shopping-basket">Delete</i></a>
						</td>
						</tr>
						<?php
					}
