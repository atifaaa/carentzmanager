        ...
        <div class="row">
          <div class="col-lg-12 main-chart">
            ...
            <div class="border-head">
              <h3>RENT CAR TRANSACTION DETAILS</h3>
            </div>
...
?>	
			      <div class="col-md-6">
					...
					<div class="col-md-6">
                      <div class="form-group">
                         <a href="print_receipt.php?id=<?php echo $id_tran;?>" class="btn btn-primary" target="_BLANK">Print Receipt</a>
						 <br><br><br><br><br><br>
                      </div>
                    </div>
					<div class="col-md-6">
                      <div class="form-group">
                         <a href="print_agreement.php?id=<?php echo $id_tran;?>" class="btn btn-danger" target="_BLANK">Print Agreement</a>
						 <br><br><br><br><br><br>
                      </div>
                    </div>
