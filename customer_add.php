...
move_uploaded_file($pict_tmp_cust,"img/".$pict_name_cust);
	...
	(cust_fullname, phone, id_number, id_driving, email, address_1, address_2,cust_picture) 
	VALUES 
	('$cust_fullname', '$phone', '$id_number', '$id_driving', '$email', '$address_1', '$address_2','$pict_name_cust')";
